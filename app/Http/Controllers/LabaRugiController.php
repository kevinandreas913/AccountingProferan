...
class LabaRugiController extends Controller
{
    ...
    public function index()
    {
        ...
        return view('pages.laporan.laba-rugi', [
            'tahun' => $joinYear,
            'bulan' => $joinMonth,
        ]);
    }
    ...
    public function print(Request $request)
    {
        ...
        $pdf = Pdf::setOptions(['dpi' => 150, 'isHtml5ParserEnabled' => true, 'isRemoteEnabled' => true])->setPaper('A4')->loadView('pdf.pdf-laba-rugi', compact('dataUsaha', 'data'));
