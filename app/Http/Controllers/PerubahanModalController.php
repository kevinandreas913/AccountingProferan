...
class PerubahanModalController extends Controller
{
    ...
    public function index()
    {
        ...
        return view('pages.laporan.perubahan-modal', [
            'tahun' => $joinYear,
            'bulan' => $joinMonth,
        ]);
    }
    ...
    public function print(Request $request)
    {
        ...
        $pdf = Pdf::setOptions(['dpi' => 150, 'isHtml5ParserEnabled' => true, 'isRemoteEnabled' => true])->setPaper('A4')->loadView('pdf.pdf-perubahan-modal', compact('dataUsaha', 'data'));
