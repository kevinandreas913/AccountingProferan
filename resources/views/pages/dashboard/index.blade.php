                        ...
                        <div class="container">
                            <div class="row">
                                <div class="col-lg-6 text-center">
                                    <h2>Assets Chart</h2>
                                    <h2 id="assetsChartTitle">Per </h2>
                                    <div class="d-flex justify-content-center" id="assets-chart"></div>
                                </div>
                                <div class="col-lg-6 text-center">
                                    <h2>Liability Chart</h2>
                                    <h2 id="liabilityChartTitle">Per </h2>
                                    <div class="d-flex justify-content-center" id="liability-chart"></div>
                                </div>
                            </div>
                        </div>
                    </div>
...
@section('scripts')
    ...
    <script>
        $(document).ready(function() {
            ...
            // assets chart
            $.ajax({
                url: "{{ route('dashboard.dataAssets') }}",
                method: 'GET',
                success: function(response) {
                    $('#assetsChartTitle').append(response.periode);
                    const options = {
                        series: [...response.dataAssets],
                        chart: {
                            height: 'auto',
                            type: 'pie',
                        },
                        labels: [...response.labelAssets],
                        responsive: [{
                            breakpoint: 576,
                            options: {
                                chart: {
                    ...
                    const chart = new ApexCharts(document.querySelector("#assets-chart"), options);
                    chart.render();
                }
            });
            ...
            // liability chart
            $.ajax({
                url: "{{ route('dashboard.dataLiability') }}",
                method: 'GET',
                success: function(response) {
                    $('#liabilityChartTitle').append(response.periode);
                    const options = {
                        series: [...response.dataLiability],
                        chart: {
                            height: 'auto',
                            type: 'pie',
                        },
                        labels: [...response.labelLiability],
                        responsive: [
                            {
                                breakpoint: 576,
                                options: {
                    ...
                    const chart = new ApexCharts(document.querySelector("#liability-chart"), options);
                    chart.render();
                }
            });
        });
